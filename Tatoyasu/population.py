import numpy as np
import torch
from Tatoyasu.network import Network
from Tatoyasu.config import input_size, elitism_pct, mutation_prob, weights_mutate_power, device
    ...
    def mutate(self):
        ...
        for model in self.models:
            for i in range(input_size):
                # 一定の確率(20%)で突然変異を行ったモデルとする * config.pyで設定変更可 *
